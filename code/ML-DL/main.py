...
def Train_MultiRun():
    ...
    cmd=[]
    # cmd.append('CUDA_VISIBLE_DEVICES={} '+'python3 main.py -D Spheres5500 -M ML-Enc')
    # cmd.append('CUDA_VISIBLE_DEVICES={} '+'python3 main.py -D Spheres5500 -M ML-AE')
    # cmd.append('CUDA_VISIBLE_DEVICES={} '+'python3 main.py -D Spheres10000 -M ML-AE')
    for i in range(10):
        cmd.append('CUDA_VISIBLE_DEVICES={} '+'python3 main.py -SD {seed}'.format(seed=i))
